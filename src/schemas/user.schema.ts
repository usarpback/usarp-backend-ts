...
export const userResponseSchema = userCreateSchema.omit({ senha: true }).describe("Retorna um usuário.");

export const userUpdateSchema = userCreateSchema.partial().describe("Atualiza um usuário.");

export const getUsersResponseSchema = {
  200: z.array(userResponseSchema).describe("Retorna uma lista com todos os usuários."),
};
...
export const deleteUserParamsSchema = getUserParamsSchema.describe("Deleta um usuário pelo ID.");
