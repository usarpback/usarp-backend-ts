...
export const getUserProjectsResponseSchema = {
  200: z.object({
    projects: z.array(projectResponseSchema).describe("Retorna uma lista com todos os projetos do usuário."),
    count: z.number().describe("Retorna a quantidade de projetos."),
  }).describe("Retorna uma lista com todos os projetos do usuário e a quantidade de projetos."),
};
