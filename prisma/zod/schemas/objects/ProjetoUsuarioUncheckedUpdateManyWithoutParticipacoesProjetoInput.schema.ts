...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUncheckedUpdateManyWithoutParticipacoesProjetoInput> =
  z
    .object({
      id: z
        .union([
...
export const ProjetoUsuarioUncheckedUpdateManyWithoutParticipacoesProjetoInputObjectSchema =
  Schema;
