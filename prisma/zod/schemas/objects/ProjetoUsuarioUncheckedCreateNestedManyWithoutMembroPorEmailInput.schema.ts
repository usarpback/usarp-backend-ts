...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUncheckedCreateNestedManyWithoutMembroPorEmailInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjetoUsuarioUncheckedCreateNestedManyWithoutMembroPorEmailInputObjectSchema =
  Schema;
