...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUncheckedCreateNestedManyWithoutProjetoInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjetoUsuarioUncheckedCreateNestedManyWithoutProjetoInputObjectSchema =
  Schema;
