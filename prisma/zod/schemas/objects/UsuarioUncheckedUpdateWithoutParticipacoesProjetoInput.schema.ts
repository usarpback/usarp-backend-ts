...
const Schema: z.ZodType<Prisma.UsuarioUncheckedUpdateWithoutParticipacoesProjetoInput> =
  z
    .object({
      id: z
        .union([
...
export const UsuarioUncheckedUpdateWithoutParticipacoesProjetoInputObjectSchema =
  Schema;
