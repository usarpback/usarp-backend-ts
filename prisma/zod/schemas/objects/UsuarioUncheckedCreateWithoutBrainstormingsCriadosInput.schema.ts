...
const Schema: z.ZodType<Prisma.UsuarioUncheckedCreateWithoutBrainstormingsCriadosInput> =
  z
    .object({
...
export const UsuarioUncheckedCreateWithoutBrainstormingsCriadosInputObjectSchema =
  Schema;
