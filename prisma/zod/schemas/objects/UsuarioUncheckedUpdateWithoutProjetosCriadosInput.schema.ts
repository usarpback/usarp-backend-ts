...
const Schema: z.ZodType<Prisma.UsuarioUncheckedUpdateWithoutProjetosCriadosInput> =
  z
    .object({
      id: z
        .union([
...
export const UsuarioUncheckedUpdateWithoutProjetosCriadosInputObjectSchema =
  Schema;
