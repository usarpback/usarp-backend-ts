...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUncheckedUpdateManyWithoutMembroPorEmailNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjetoUsuarioUncheckedUpdateManyWithoutMembroPorEmailNestedInputObjectSchema =
  Schema;
