...
const Schema: z.ZodType<Prisma.BrainstormingProjetoCreateNestedManyWithoutBrainstormingInput> =
  z
    .object({
      create: z
        .union([
...
export const BrainstormingProjetoCreateNestedManyWithoutBrainstormingInputObjectSchema =
  Schema;
