...
const Schema: z.ZodType<Prisma.BrainstormingProjetoUncheckedUpdateManyWithoutBrainstormingNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BrainstormingProjetoUncheckedUpdateManyWithoutBrainstormingNestedInputObjectSchema =
  Schema;
