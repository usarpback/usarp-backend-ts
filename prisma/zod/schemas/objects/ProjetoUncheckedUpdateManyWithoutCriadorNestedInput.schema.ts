...
const Schema: z.ZodType<Prisma.ProjetoUncheckedUpdateManyWithoutCriadorNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => ProjetoUpdateManyWithWhereWithoutCriadorInputObjectSchema,
          ),
          z
            .lazy(
              () => ProjetoUpdateManyWithWhereWithoutCriadorInputObjectSchema,
...
export const ProjetoUncheckedUpdateManyWithoutCriadorNestedInputObjectSchema =
  Schema;
