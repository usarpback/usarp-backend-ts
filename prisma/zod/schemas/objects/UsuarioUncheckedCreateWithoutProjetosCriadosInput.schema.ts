...
const Schema: z.ZodType<Prisma.UsuarioUncheckedCreateWithoutProjetosCriadosInput> =
  z
    .object({
...
export const UsuarioUncheckedCreateWithoutProjetosCriadosInputObjectSchema =
  Schema;
