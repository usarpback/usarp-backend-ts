...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUpdateManyWithoutMembroNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjetoUsuarioUpdateManyWithoutMembroNestedInputObjectSchema =
  Schema;
