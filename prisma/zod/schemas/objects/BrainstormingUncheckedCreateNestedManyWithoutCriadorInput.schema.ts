...
const Schema: z.ZodType<Prisma.BrainstormingUncheckedCreateNestedManyWithoutCriadorInput> =
  z
    .object({
      create: z
        .union([
...
export const BrainstormingUncheckedCreateNestedManyWithoutCriadorInputObjectSchema =
  Schema;
