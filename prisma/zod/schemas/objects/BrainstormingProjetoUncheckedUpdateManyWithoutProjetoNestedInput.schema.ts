...
const Schema: z.ZodType<Prisma.BrainstormingProjetoUncheckedUpdateManyWithoutProjetoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BrainstormingProjetoUncheckedUpdateManyWithoutProjetoNestedInputObjectSchema =
  Schema;
