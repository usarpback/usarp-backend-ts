...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUncheckedUpdateManyWithoutMembrosInput> =
  z
    .object({
      id: z
        .union([
...
export const ProjetoUsuarioUncheckedUpdateManyWithoutMembrosInputObjectSchema =
  Schema;
