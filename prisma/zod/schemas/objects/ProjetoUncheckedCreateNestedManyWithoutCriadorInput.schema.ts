...
const Schema: z.ZodType<Prisma.ProjetoUncheckedCreateNestedManyWithoutCriadorInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjetoUncheckedCreateNestedManyWithoutCriadorInputObjectSchema =
  Schema;
