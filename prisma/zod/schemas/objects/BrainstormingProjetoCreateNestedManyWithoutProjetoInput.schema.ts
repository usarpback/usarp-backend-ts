...
const Schema: z.ZodType<Prisma.BrainstormingProjetoCreateNestedManyWithoutProjetoInput> =
  z
    .object({
      create: z
        .union([
...
export const BrainstormingProjetoCreateNestedManyWithoutProjetoInputObjectSchema =
  Schema;
