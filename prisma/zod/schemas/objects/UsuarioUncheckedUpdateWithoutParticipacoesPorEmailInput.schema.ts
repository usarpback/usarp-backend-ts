...
const Schema: z.ZodType<Prisma.UsuarioUncheckedUpdateWithoutParticipacoesPorEmailInput> =
  z
    .object({
      id: z
        .union([
...
export const UsuarioUncheckedUpdateWithoutParticipacoesPorEmailInputObjectSchema =
  Schema;
