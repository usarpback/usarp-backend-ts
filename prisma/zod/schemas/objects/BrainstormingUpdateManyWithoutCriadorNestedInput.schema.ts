...
const Schema: z.ZodType<Prisma.BrainstormingUpdateManyWithoutCriadorNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const BrainstormingUpdateManyWithoutCriadorNestedInputObjectSchema =
  Schema;
