...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUncheckedCreateNestedManyWithoutMembroInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjetoUsuarioUncheckedCreateNestedManyWithoutMembroInputObjectSchema =
  Schema;
