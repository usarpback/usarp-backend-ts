...
const Schema: z.ZodType<Prisma.UsuarioUncheckedUpdateWithoutBrainstormingsCriadosInput> =
  z
    .object({
      id: z
        .union([
...
export const UsuarioUncheckedUpdateWithoutBrainstormingsCriadosInputObjectSchema =
  Schema;
