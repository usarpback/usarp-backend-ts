...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUncheckedUpdateManyWithoutProjetoNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProjetoUsuarioUncheckedUpdateManyWithoutProjetoNestedInputObjectSchema =
  Schema;
