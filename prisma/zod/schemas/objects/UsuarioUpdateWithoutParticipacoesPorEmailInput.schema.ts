...
const Schema: z.ZodType<Prisma.UsuarioUpdateWithoutParticipacoesPorEmailInput> =
  z
    .object({
      id: z
        .union([
      ...
      brainstormingsCriados: z
        .lazy(
          () => BrainstormingUpdateManyWithoutCriadorNestedInputObjectSchema,
        )
        .optional(),
      participacoesProjeto: z
        .lazy(
          () => ProjetoUsuarioUpdateManyWithoutMembroNestedInputObjectSchema,
        )
        .optional(),
    })
    .strict();

export const UsuarioUpdateWithoutParticipacoesPorEmailInputObjectSchema =
  Schema;
