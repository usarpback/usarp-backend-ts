...
import { ProjetoUpdateOneRequiredWithoutMembrosNestedInputObjectSchema } from './ProjetoUpdateOneRequiredWithoutMembrosNestedInput.schema';
...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUpdateWithoutMembroPorEmailInput> =
  z
    .object({
      id: z
        .union([
      ...
      projeto: z
        .lazy(
          () => ProjetoUpdateOneRequiredWithoutMembrosNestedInputObjectSchema,
        )
        .optional(),
      membro: z
        .lazy(
...
export const ProjetoUsuarioUpdateWithoutMembroPorEmailInputObjectSchema =
  Schema;
