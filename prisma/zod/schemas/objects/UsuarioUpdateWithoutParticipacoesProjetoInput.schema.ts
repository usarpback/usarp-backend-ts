...
const Schema: z.ZodType<Prisma.UsuarioUpdateWithoutParticipacoesProjetoInput> =
  z
    .object({
      id: z
        .union([
...
export const UsuarioUpdateWithoutParticipacoesProjetoInputObjectSchema = Schema;
