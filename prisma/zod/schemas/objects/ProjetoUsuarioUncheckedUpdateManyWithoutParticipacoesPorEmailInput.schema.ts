...
const Schema: z.ZodType<Prisma.ProjetoUsuarioUncheckedUpdateManyWithoutParticipacoesPorEmailInput> =
  z
    .object({
      id: z
        .union([
...
export const ProjetoUsuarioUncheckedUpdateManyWithoutParticipacoesPorEmailInputObjectSchema =
  Schema;
